  ...
  <b-container class="mt-4" v-if="loginUserInfo">
    ...
    <b-col cols="2" id="left">
      <div
        ...
        "
      >
        <span class="ml-2" style="font-size: 20px text-center">회원관리</span>
      </div>
      <div class="ml-3">
        <b-button variant="primary" style="width: 200px">정보 조회</b-button>
      </div>
      <div class="ml-3 mt-3">
        <b-button variant="success" style="width: 200px">정보 수정</b-button>
      </div>
      <div class="ml-3 mt-3">
        <b-button variant="danger" style="width: 200px">회원 탈퇴</b-button>
      </div>
      <div
        style="
          text-align: left;
      ...
      <div class="ml-3 mt-3">
        <b-button variant="warning" style="width: 200px">메인으로</b-button>
      </div>
      <div class="ml-3 mt-3">
