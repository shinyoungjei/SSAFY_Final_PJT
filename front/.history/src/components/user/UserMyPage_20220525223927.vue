  ...
  <b-container v-if="loginUserInfo">
    ...
    <b-row style="text-align: center">
      <b-col class="text-primary font-weight-bold">
        <h1 style="font-size: 55px">마이 페이지</h1>
      </b-col>
    </b-row>
          ...
          <template v-if="mode === `mvChange`">
            ...
            <b-row>
              ...
              <b-col>
                ...
                <div
                  v-if="mypass != loginUserInfo.pass"
          ...
          <template v-if="mode === `mvDelete`">
            ...
            <b-row>
              ...
              <b-col>
                ...
                <div
                  v-if="changepass != loginUserInfo.pass"
                  style="font-size: 10px"
                  class="text-right"
                >
                  비밀번호가 일치하지 않습니다.
            ...
            <b-row class="mt-4">
              ...
              <b-col>
                ...
                <b-button v-b-modal.modalPopover>탈퇴하기</b-button>
                <b-modal id="modalPopover" title="회원 탈퇴하기" ok-only>
                  <p>
                    회원 탈퇴를 취소하시려면
                    <b-button
