  ...
  <b-container class="mt-4" v-if="loginUserInfo">
    ...
    <b-row>
      ...
      <b-col id="left">
        ...
        <div class="ml-3">
          ...
          <b-modal id="modal-1" title="회원 정보">
            <b-container class="mt-2 text-center">
              ...
              <b-row>
                <b-col></b-col>
                <b-col>비밀번호</b-col><b-col>{{ loginUserInfo.pass }}</b-col>
                <b-col></b-col>
              </b-row>
            </b-container>
          </b-modal>
        ...
        <div class="ml-3 mt-3">
          ...
          <b-modal id="modal-2" title="수정하기">
            <b-container class="mt-2 text-center">
              ...
              <button class="btn btn-warning" @click="modify">수정</button>
            </b-container>
          </b-modal>
        </div>
        <!-- 정보수정 종료 -->
        ...
        <div class="ml-3 mt-3">
          <b-button variant="light" style="width: 200px" :to="{ name: `home` }"
            >메인으로</b-button
          >
        </div>
        <div class="ml-3 mt-3">
