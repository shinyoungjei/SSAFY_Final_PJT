              ...
              <b-col>
                <b-input-group class="mt-2">
                  ...
                  <b-form-input
                    ...
                    class="text-center"
                    v-model="mypass"
                    @keyup="confirmPassword(mypass)"
                  />
                </b-input-group>

                <div
                  v-if="loginUserInfo.id != passCheck"
...
export default {
  ...
  component: {},
  computed: {
    ...mapState(userStore, ["loginUserInfo", "passCheck"]),
  },
  ...
  methods: {
    ...
    userDelete() {
      if (confirm("정말 탈퇴하시겠습니까?")) {
        this.doDeleteUser(this.loginUserInfo.id);
    ...
    async confirmPassword(password) {
      ...
      await this.checkUserPassword(passwordCheckInfo);
    ...
    modifyPassword() {
      ...
      this.doModifyUserPassword(passwordCheckInfo);
      this.$router.push("/");
    },
  },
};
