      ...
      <b-col>
        <b-input-group class="mt-3">
          <b-form-input
            ...
            @keyup.enter="getNoticeListBySubject"
            placeholder="제목으로 검색"
          ></b-form-input>
          <b-input-group-append>
            <b-button
              variant="primary"
              text="Button"
              @click.prevent="getNoticeListBySubject"
              >검색</b-button
            >
          </b-input-group-append>
        </b-input-group>
...
export default {
  ...
  methods: {
    ...mapActions(noticeStore, ["setNotices", "searchNoticeBySubject"]),

    getNoticeListBySubject() {
      if (this.searchKeyword == "") {
        this.setNotices();
        return;
      }
      this.searchNoticeBySubject(this.searchKeyword);
    },
  },
};
</script>
