  ...
  <b-container class="bv-example-row">
    ...
    <b-row style="text-align: center">
      <b-col class="text-primary font-weight-bold">
        <h1 style="font-size: 50px">질문 상세보기</h1>
      </b-col>
    </b-row>
    <div style="height: 50px"></div>
    <b-row>
      <b-col class="text-right mb-1">
        <b-button variant="outline-primary" v-on:click="moveUpdate"
          >수정</b-button
        >
        <b-button variant="outline-primary" @click="moveDelete">삭제</b-button>
      </b-col>
    </b-row>
    ...
    <b-row>
      ...
      <b-col cols="1">
        ...
        <b-button variant="outline-primary" @click="registerTodo"
          >등록</b-button
        >
      </b-col>
    </b-row>
